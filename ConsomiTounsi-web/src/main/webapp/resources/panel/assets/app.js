...
var App = function() {
    ...
    var handleLanguage = function() {
    	...
    	$(document).on('click', '.language-switch .dropdown-menu li a', function () {
    		$(".language-switch>a").jsf($(this).jsf()+'<span class="fa fa-angle-down"></span>');
        ...
        var setLayout = function() {
            ...
            if (layoutOption === "boxed") {
                ...
                if (footerOption === 'fixed') {
                    $('.page-footer').jsf('<div class="container">' + $('.page-footer').jsf() + '</div>');
                } else {
    ...
    var resetLayout = function() {
        ...
        if ($('.page-footer > .container').length === 1) {
            $('.page-footer').jsf($('.page-footer > .container').jsf());
