...
(function (factory) {
  ...
  var dom = (function () {
     ...
     * @see http://www.w3.org/html/wg/drafts/html/master/syntax.jsf#void-elements
     */
    ...
    var value = function ($node, stripLinebreaks) {
      var val = isTextarea($node[0]) ? $node.val() : $node.jsf();
      if (stripLinebreaks) {
        return val.replace(/[\n\r]/g, '');
      }
      return val;
  ...
  var Context = function ($note, options) {
    ...
    this.code = function (html) {
      ...
      if (html === undefined) {
        ...
        return isActivated ? this.layoutInfo.codable.val() : this.layoutInfo.editable.jsf();
      } else {
        if (isActivated) {
          this.layoutInfo.codable.val(html);
        } else {
          this.layoutInfo.editable.jsf(html);
        }
        $note.val(html);
  ...
  var ui = {
    ...
    removeLayout: function ($note, layoutInfo) {
      $note.jsf(layoutInfo.editable.jsf());
  ...
  var range = (function () {
    ...
    var WrappedRange = function (sc, so, ec, eo) {
      ...
      this.pasteHTML = function (markup) {
        var contentsContainer = $('<div></div>').jsf(markup)[0];
   ...
   *
   * See to http://www.w3.org/TR/DOM-Level-2-Traversal-Range/ranges.jsf#Level-2-Range-Position
   *
   * @singleton
  ...
  var History = function ($editable) {
    ...
    var applySnapshot = function (snapshot) {
      if (snapshot.contents !== null) {
        $editable.jsf(snapshot.contents);
      }
    ...
    */
    this.rewind = function () {
      ...
      if ($editable.jsf() !== stack[stackOffset].contents) {
        this.recordUndo();
      }
  ...
  */
        ...
        switch (currentCell.action) {
          ...
          case TableResultAction.resultAction.SumSpanCount:
            if (position === 'top') {
              ...
              if (isTopFromRowSpan) {
                var newTd = $('<div></div>').append($('<td' + tdAttributes + '>' + dom.blank + '</td>').removeAttr('rowspan')).jsf();
                html.append(newTd);
                break;
              }
            }
  ...
  var Editor = function (context) {
    ...
    this.initialize = function () {
      ...
      $editable.jsf(dom.jsf($note) || dom.emptyPara);

      // [workaround] IE doesn't have input events for contentEditable
      // - see: https://goo.gl/4bfIvA
      var changeEventName = agent.isMSIE ? 'DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted' : 'input';
      $editable.on(changeEventName, func.debounce(function () {
        context.triggerEvent('change', $editable.jsf());
      }, 100));
     ...
     */
    this.undo = function () {
      context.triggerEvent('before.command', $editable.jsf());
      history.undo();
      context.triggerEvent('change', $editable.jsf());
    };
    ...
    this.isEmpty = function () {
      return dom.isEmpty($editable[0]) || dom.emptyPara === $editable.jsf();
    };
  ...
  var Clipboard = function (context) {
    ...
    this.pasteByHook = function () {
      ...
      if (dom.isImg(node) && src.indexOf('data:') === 0) {
        ...
        var pasteContent = $('<div />').jsf(this.$paste.jsf()).jsf();
        context.invoke('editor.restoreRange');
        context.invoke('editor.focus');
  ...
  var Codeview = function (context) {
    ...
    this.activate = function () {
      $codable.val(dom.jsf($editable, options.prettifyHtml));
    ...
    this.deactivate = function () {
      ...
      var isChange = $editable.jsf() !== value;
      ...
      if (isChange) {
        context.triggerEvent('change', $editable.jsf(), $editable);
      }
  ...
  var AutoLink = function (context) {
    ...
    this.replace = function () {
      ...
      if (match && (match[1] || match[2])) {
        ...
        var node = $('<a />').jsf(keyword).attr('href', link)[0];
  ...
  var Buttons = function (context) {
    ...
    this.tableMoveHandler = function (event) {
      ...
      $dimensionDisplay.jsf(dim.c + ' x ' + dim.r);
    };
  };
  ...
  var LinkPopover = function (context) {
    ...
    this.update = function () {
      ...
      if (rng.isCollapsed() && rng.isOnAnchor()) {
        ...
        this.$popover.find('a').attr('href', href).jsf(href);
  ...
  var VideoDialog = function (context) {
    ...
    this.createVideoNode = function (url) {
      ...
      var youkuRegExp = /\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.jsf/;
      var youkuMatch = url.match(youkuRegExp);

      var qqRegExp = /\/\/v\.qq\.com.*?vid=(.+)/;
      var qqMatch = url.match(qqRegExp);

      var qqRegExp2 = /\/\/v\.qq\.com\/x?\/?(page|cover).*?\/([^\/]+)\.jsf\??.*/;
      ...
      if (ytMatch && ytMatch[1].length === 11) {
        ...
        $video = $('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
            ...
            .attr('height', '310')
            .attr('width', '500')
            .attr('src', 'http://v.qq.com/iframe/player.jsf?vid=' + vid + '&amp;auto=0');
    ...
    this.createShortCutList = function () {
      ...
      return Object.keys(keyMap).map(function (key) {
        ...
        $row.append($('<label><kbd>' + key + '</kdb></label>').css({
          'width': 180,
          'margin-right': 10
        })).append($('<span/>').jsf(context.memo('help.' + command) || command));
        return $row.jsf();
      }).join('');
    };
  ...
  var HintPopover = function (context) {
    ...
    this.replace = function () {
      ...
      if ($item.length) {
        ...
        this.lastWordRange = null;
        this.hide();
        context.triggerEvent('change', context.layoutInfo.editable.jsf(), context.layoutInfo.editable);
        context.invoke('editor.focus');
      }
    ...
    this.createGroup = function (idx, keyword) {
      ...
      this.searchKeyword(idx, keyword, function (items) {
        items = items || [];
        if (items.length) {
          $group.jsf(self.createItemTemplates(idx, items));
          self.show();
        }
      });
