"use strict";
//alert(document.getElementById("donc").textContent);
//var collect = document.getElementById("doncol").textContent;
//alert(collect);
...
window.onload = function() {
  ...
  var User = {
    name: " ",
    donationCollect: document.getElementById("doncol").textContent,
    
    //donationCollect: document.getElementById("doncol"),
    donationGoal: document.getElementById("dongoal").textContent
    //donationGoal: document.getElementById("dongoal")
  };
  ...
  var donationUser = document.getElementById("donation--user"),
    ...
    donate = document.getElementById("f:donate");
  ...
  // Default Data
  donationUser.innerHTML = "Progress";
